...
const STORY_CHAPTERS = [
  ...
  },
  {
    ...
    bodyEs: "Joshua planeó la pedida de mano soñada de Ana durante una semana que pasaron en Austin, Texas, apoyando a un amigo cercano en un triatlón. Si bien amigos y familiares sabían que algo especial se avecinaba ese viernes, Ana no tenía ni idea de lo que estaba a punto de suceder. Con el impresionante paisaje del Monte Bonnell de fondo, Joshua le dedicó unas palabras conmovedoras a Ana antes de arrodillarse para pedirle matrimonio. Para su sorpresa, todos sus familiares y amigos más cercanos estaban cerca, esperando para presenciar el momento. Ver a las personas que más significan para ellos celebrar esta ocasión tan especial llenó a Ana de una inmensa alegría y gratitud, y se sintió profundamente conmovida por la consideración y la dedicación de Joshua para hacer de ese día algo verdaderamente inolvidable. Después de la pedida de mano, disfrutaron de un maravilloso almuerzo con todos, escuchando todos los detalles de la meticulosa planificación de Joshua: las historias que recopiló, los ayudantes que hicieron posible el día y los muchos detalles que añadió, incluyendo la creación de la caja del anillo. Cada detalle reflejaba no solo el amor de Joshua por Ana, sino también el amor de todos aquellos que han formado parte de su historia juntos. La pedida de mano de Ana y Joshua fue un reflejo perfecto de su relación: llena de amor, alegría, cariño y el precioso apoyo de todos los que han desempeñado un papel especial en su historia.",
